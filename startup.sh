...
-------------------------------------
"
su steam -c "winetricks -q dotnet472"
su steam -c "winetricks -q d3dcompiler_47"
su steam -c "winetricks -q vcrun2013"
su steam -c "winetricks -q fonts list"
su steam -c "winetricks -q allfonts"
